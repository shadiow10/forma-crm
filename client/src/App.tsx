...
function Teachers({ setSelectedTeacher, setNotice }: { setSelectedTeacher: (teacher: Teacher) => void; setNotice: (message: string) => void }) {
  return <>
    <PageHeader eyebrow="Équipe pédagogique" title="Formateurs" description="Un annuaire clair pour piloter l'équipe et les heures enseignées." action actionLabel="Ajouter un formateur" onAction={() => setNotice("Formulaire d'ajout d'formateur ouvert.")} />
